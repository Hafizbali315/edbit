		...
		<div className="login_page">
			<div className="login_card">
				...
				<div className="login_form">
					<input class="form-control form-control-lg mb-4" type="text" placeholder="First Name" />
					<input class="form-control form-control-lg mb-4" type="text" placeholder="Middle Name" />
					<input class="form-control form-control-lg mb-4" type="text" placeholder="Last Name" />
